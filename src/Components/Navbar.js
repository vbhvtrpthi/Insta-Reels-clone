...
const useStyles = makeStyles({
    appb:{
        background: 'linear-gradient(white 1%, white 1%)',
         color: 'yellow'
    }
})
...
export default function Navbar({userData}) {
    ...
    const handleexplore = ()=>{
        //for going into complete differnet url
    ...
    //renderMenu jo chota sa modla khula tha
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="fixed" className={classes.appbb}  sx={{background:'white'}}>
                <Toolbar>
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' },color: 'black', alignItems: 'center',marginRight:'4rem'}}>
                        ...
                        >
                            {/* ye wala AccountCircle icon mui ney hume bana key diya hai jiskey click par profile aur logout khulta hai */}
                            {/* <AccountCircle /> */}
